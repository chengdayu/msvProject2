...
int fuhe<==0 and skip;
     ...
     if(return_1=0)   then 
     {
         ...
         while(zuheshu_i<n)
         {
             if(zuheshu_i=0) then 
             {
                 ...
                 float *zuheshu_2_p and skip;
                 zuheshu_2_p:=fsz(n-1,RValue);
             ...
             else
             {
                 ...
                 {
                     zuhe[4-n]:=s[zuheshu_i];
                     float *zuheshu_4_5_p and skip;
                     zuheshu_4_5_p:=fsz(n-1,RValue);
 ...
 {
     frame(zuhefu_opter,zuhefu_h,zuhefu_i,zuhefu_j,zuhefu_op,zuhefu_khzh,zuhefu_k,nm_1$,break_1$,switch_1,zuhefu_1_m,zuhefu_1_n,return_1,break_1,continue_1) and ( 
                 ...
                 while(zuhefu_k<=3)
                 {
                     ...
                     if (nm_1$=1 or (switch_1=1 and break_1$=0 and return_1=0) ) then 
                     {
                         ...
                         while(zuhefu_1_m<=3)
                         {
                             ...
                             while( break_1=0 and  zuhefu_1_n<=3)
                             {
                                  continue_1<==0 and skip;
                                 if(zuhefu_1_m>3) then 
                                 {
                                     if(zuhefu_1_m=4 and zuhefu_1_n=3) then 
                                     {
                                         break_1<==1 and skip
                                      }
                                     else 
                                     ...
                                     if(break_1=0)   then
                                     {
                                         if(zuhefu_1_m=5 and zuhefu_1_n=2) then 
                                         {
                                             chufa(suanshi,r,RValue);
                                             break_1<==1 and skip
                                         ...
                                         if(break_1=0)   then
                                         {
                                             if(zuhefu_1_m=4 and zuhefu_1_n=1) then 
                                             {
                                                 break_1<==1 and skip
                                              }
                                             else 
                                             ...
                                             if(break_1=0)   then
                                             {
                                                 if(zuhefu_1_m=5 and zuhefu_1_n=3) then 
                                                 {
                                                     chufa(suanshi,r,RValue);
                                                     break_1<==1 and skip
                                 ...
                                 if(break_1=0)   then 
                                 {
                                     if(zuhefu_1_m=2 and zuhefu_1_n=3) then 
                                     {
                                         ...
                                         {
                                             if(zuhefu_1_m=1 and zuhefu_1_n=2) then 
                                             {
                                                 continue_1<==1 and skip;
                                                  zuhefu_1_n:=zuhefu_1_n+1}
                                                 else 
                                                 ...
                                                 if(continue_1=0)   then 
                                                 {
                                                     if(zuhefu_1_m=3 and zuhefu_1_n=1) then 
                                                     {
                                                         continue_1<==1 and skip;
                                                          zuhefu_1_n:=zuhefu_1_n+1}
                                                         else 
                                                         ...
                                                         if(continue_1=0)   then 
                                                         {
                                                             if(zuhefu_1_m=1 and zuhefu_1_n=3) then 
                                                             {
                                                                 continue_1<==1 and skip;
                                                                  zuhefu_1_n:=zuhefu_1_n+1}
                                                                 else 
                                     ...
                                     if (nm_1$=4 or (switch_1=1 and break_1$=0 and return_1=0) ) then 
                                     {
                                         switch_1<==1 and skip;
                                         break_1$<==1 and skip
  ...
  function yunsuan ( float s[],char p[],int k0[],int k1[],int RValue )
 {
     ...
     float *yunsuan_suanshi and skip;
     yunsuan_suanshi:=fsz(yunsuan_r,RValue);
  ...
  function hefa ( float suanshi[],int r,int RValue )
 {
     ...
     int break_1<==0 and skip;
     int return_1<==0 and skip;
     float *hefa_p and skip;
     hefa_p:=&suanshi[0];
     float *hefa_q and skip;
     hefa_q:=&suanshi[1];
  ...
  function jianjie ( float suanshi[],int r,float RValue )
 {
     ...
     float *jianjie_p and skip;
     jianjie_p:=&jianjie_re;
     float *jianjie_q and skip;
 ...
 {
     frame(qiujie_1_a,nm_3$,break_1$,switch_1,qiujie_pq,qiujie_p,qiujie_q,qiujie_k,qiujie_suanshi1,qiujie_s,qiujie_sum,qiujie_m,nm_4$,qiujie_9_10_11_12_ws,qiujie_9_10_11_12_w,qiujie_9_10_11_15_16_ws,qiujie_9_10_11_15_16_w,qiujie_9_10_25_26_ws,qiujie_9_10_25_26_w,qiujie_9_10_25_29_30_ws,qiujie_9_10_25_29_30_w,return_1,continue_1) and ( 
     int continue_1<==0 and skip;
     int return_1<==0 and skip;
     if(n=3) then 
     {
     ...
     if(return_1=0)   then 
     {
         ...
         else
         {
             ...
             while(qiujie_m<(qiujie_s-1)/ 2)
             {
                 ...
                 {
                     switch_1<==1 and skip;
                     if((qiujie_s-1)/ 2!=1) then 
                     {
                         if(qiujie_suanshi1[2*(qiujie_m+1)+1]='*') then 
                         {
                             * qiujie_q:=qiujie(qiujie_p+2,3,RValue);
                             int qiujie_9_10_11_12_ws<==&qiujie_suanshi1[qiujie_s-1]-&qiujie_suanshi1[2*(qiujie_m+1)] and skip;
                             int qiujie_9_10_11_12_w<==1 and skip;
                             
                             while(qiujie_9_10_11_12_w<=qiujie_9_10_11_12_ws)
                             {
                                 if(((qiujie_q+qiujie_9_10_11_12_w+2)-(qiujie_q+qiujie_9_10_11_12_ws))>0) then 
                                 {
                                     * (qiujie_q+qiujie_9_10_11_12_w):=-1
                                     
                                 }
                                 else
                                 {
                                     * (qiujie_q+qiujie_9_10_11_12_w):=* (qiujie_q+qiujie_9_10_11_12_w+2)
                                 };
                                 qiujie_9_10_11_12_w:=qiujie_9_10_11_12_w+1
                         ...
                         else
                         {
                             ...
                             {
                                 * qiujie_q:=qiujie(qiujie_p+2,3,RValue);
                                 int qiujie_9_10_11_15_16_ws<==&qiujie_suanshi1[qiujie_s-1]-&qiujie_suanshi1[2*(qiujie_m+1)] and skip;
                                 int qiujie_9_10_11_15_16_w<==1 and skip;
                                 
                                 while(qiujie_9_10_11_15_16_w<=qiujie_9_10_11_15_16_ws)
                                 {
                                     if(((qiujie_q+qiujie_9_10_11_15_16_w+2)-(qiujie_q+qiujie_9_10_11_15_16_ws))>0) then 
                                     {
                                         * (qiujie_q+qiujie_9_10_11_15_16_w):=-1
                                         
                                     }
                                     else
                                     {
                                         * (qiujie_q+qiujie_9_10_11_15_16_w):=* (qiujie_q+qiujie_9_10_11_15_16_w+2)
                                     };
                                     qiujie_9_10_11_15_16_w:=qiujie_9_10_11_15_16_w+1
                 ...
                 if (nm_4$='-' or (switch_1=1 and break_1$=0 and return_1=0) ) then 
                 {
                     ...
                     if((qiujie_s-1)/ 2!=1) then 
                     {
                         ...
                         {
                             * qiujie_q:=qiujie(qiujie_p+2,3,RValue);
                             int qiujie_9_10_25_26_ws<==&qiujie_suanshi1[qiujie_s-1]-&qiujie_suanshi1[2*(qiujie_m+1)] and skip;
                             int qiujie_9_10_25_26_w<==1 and skip;
                             
                             while(qiujie_9_10_25_26_w<=qiujie_9_10_25_26_ws)
                             {
                                 if(((qiujie_q+qiujie_9_10_25_26_w+2)-(qiujie_q+qiujie_9_10_25_26_ws))>0) then 
                                 {
                                     * (qiujie_q+qiujie_9_10_25_26_w):=-1
                                     
                                 }
                                 else
                                 {
                                     * (qiujie_q+qiujie_9_10_25_26_w):=* (qiujie_q+qiujie_9_10_25_26_w+2)
                                 };
                                 qiujie_9_10_25_26_w:=qiujie_9_10_25_26_w+1
                         ...
                         else
                         {
                             ...
                             {
                                 * qiujie_q:=qiujie(qiujie_p+2,3,RValue);
                                 int qiujie_9_10_25_29_30_ws and skip;
                                 qiujie_9_10_25_29_30_ws:=&qiujie_suanshi1[qiujie_s-1]-&qiujie_suanshi1[2*(qiujie_m+1)];
                                 int qiujie_9_10_25_29_30_w<==1 and skip;
                                 
                                 while(qiujie_9_10_25_29_30_w<=qiujie_9_10_25_29_30_ws)
                                 {
                                     if(((qiujie_q+qiujie_9_10_25_29_30_w+2)-(qiujie_q+qiujie_9_10_25_29_30_ws))>0) then 
                                     {
                                         * (qiujie_q+qiujie_9_10_25_29_30_w):=-1
                                         
                                     }
                                     else
                                     {
                                         * (qiujie_q+qiujie_9_10_25_29_30_w):=* (qiujie_q+qiujie_9_10_25_29_30_w+2)
                                     };
                                     qiujie_9_10_25_29_30_w:=qiujie_9_10_25_29_30_w+1
  ...
  function chufa ( float suanshi[],int r,int RValue )
 {
     frame(chufa_p,chufa_q,chufa_flag,nm_5$,break_1$,switch_1,return_1,break_1) and (
     int break_1<==0 and skip;
     int return_1<==0 and skip;
     float *chufa_p and skip;
     chufa_p:=&suanshi[0];
     float *chufa_q and skip;
     chufa_q:=&suanshi[1];
     int chufa_flag<==1 and skip;
     int switch_1 and skip;
     int break_1$ and skip;
     break_1$<==0 and skip;
      switch_1<==0 and skip;
      int nm_5$ and skip;
     nm_5$ := chufa_q;
     if (nm_5$=0 or (switch_1=1 and break_1$=0 and return_1=0) ) then 
     {
         switch_1<==1 and skip;
         if(k0[0]=1) then 
         {
     ...
     if (nm_5$=1 or (switch_1=1 and break_1$=0 and return_1=0) ) then 
     {
         switch_1<==1 and skip;
         suanshi0[r]:=s[0];
         r:=r+1;
     ...
     if (nm_5$=2 or (switch_1=1 and break_1$=0 and return_1=0) ) then 
     {
         switch_1<==1 and skip;
         suanshi0[r]:=chufa_p[0];
         r:=r+1;
         break_1$<==1 and skip
     ...
     if (nm_5$=3 or (switch_1=1 and break_1$=0 and return_1=0) ) then 
     {
         switch_1<==1 and skip;
         if(k0[1]=1) then 
         {
     ...
     if (nm_5$=4 or (switch_1=1 and break_1$=0 and return_1=0) ) then 
     {
         switch_1<==1 and skip;
         suanshi0[r]:=s[1];
         r:=r+1;
     ...
     if (nm_5$=5 or (switch_1=1 and break_1$=0 and return_1=0) ) then 
     {
         switch_1<==1 and skip;
         if(k1[0]=1) then 
         {
     ...
     if (nm_5$=6 or (switch_1=1 and break_1$=0 and return_1=0) ) then 
     {
         switch_1<==1 and skip;
         suanshi0[r]:=chufa_p[1];
         r:=r+1;
         break_1$<==1 and skip
     ...
     if (nm_5$=7 or (switch_1=1 and break_1$=0 and return_1=0) ) then 
     {
         switch_1<==1 and skip;
         if(k0[2]=1) then 
         {
     ...
     if (nm_5$=8 or (switch_1=1 and break_1$=0 and return_1=0) ) then 
     {
         switch_1<==1 and skip;
         suanshi0[r]:=s[2];
         r:=r+1;
     ...
     if (nm_5$=9 or (switch_1=1 and break_1$=0 and return_1=0) ) then 
     {
         switch_1<==1 and skip;
         if(k1[1]=1) then 
         {
     ...
     break_1<==0 and skip;
     return_1<==1 and RValue:=chufa_flag;
     skip
     )
 };
  main()
