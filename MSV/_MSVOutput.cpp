...
struct ATrans *$$$simplify_astates_t0;
...
;
if (return_1==0){if (return_1==0){struct Cache $$$in_cache_d6;
...
if ((implies(1,ptr->lft,bin_simpler_1_2_27_temp$_32)) || (implies(1,ptr->rgt,bin_simpler_1_2_27_temp$_29))){break_1$=1;
...
if ((implies(1,bin_simpler_1_2_36_temp$_44,ptr->lft)) || (implies(1,bin_simpler_1_2_36_temp$_41,ptr->rgt))){break_1$=1;
ptr=tl_nn(0,TRUE,NULL,NULL);
}
;
if (break_1$==0){break_1$=1;
...
;
if (return_1==0){if (goto==0){struct Node $$$addcan_prev8;
$$$addcan_prev8=addcan_m;
struct Node $$$addcan_m9;
...
struct Node $$$Canonical_m10;
$$$Canonical_m10=can;
struct Node $$$Canonical_prev11;
