...
while(!((simplify_gtrans_t!=simplify_gtrans_t1) && ((simplify_gtrans_t1->to==simplify_gtrans_t->to) && ((included_set(1,simplify_gtrans_t1->pos,simplify_gtrans_t->pos,1)) && ((included_set(1,simplify_gtrans_t1->neg,simplify_gtrans_t->neg,1)) && ((externincluded_set(simplify_gtrans_t->final,simplify_gtrans_t1->final,0,RValue)) || ((tl_simp_scc) && ((simplify_gtrans_s->incoming!=simplify_gtrans_t->to->incoming) || (in_set(1,bad_scc,simplify_gtrans_s->incoming)))))))))){simplify_gtrans_t1=simplify_gtrans_t1->nxt;
}
;
