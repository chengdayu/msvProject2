...
=======
<<<<<<< HEAD
>>>>>>> 22e480a3b7e89f73f1377c8c7b33791532cc9670
...
int prec[2][4]={{U_OPER,V_OPER,0,0},{OR_1,AND_1,IMPLIES,EQUIV}};
struct Node *can;
int mod;
...
void  getword(int $$Ext,int first,);
...
*  tl_emalloc(int $$Ext,int U);
void  tfree(int $$Ext,*v);
...
void  alldone(int $$Ext,int estatus){
if (strlen(out1)>0){unlink((char *)(out1),RValue);
}
;
}
char *  emalloc(int $$Ext,int n){
...
if (!(empty_intersect_sets((*(result))->(pos),(*(result))->(neg),1,RValue))){free_atrans(0,*(result),0);
*(result)=NULL;
}
;
}
...
return_1=0;
already_done_i=1;
while(return_1==(0) && (already_done_i<node_id)){if (isequal(0,p,label[already_done_i])){return_1=1;
...
while(break_1==(0) && (simplify_atrans_t1)){if ((simplify_atrans_t1!=simplify_atrans_t) && ((included_set((simplify_atrans_t1)->(to),(simplify_atrans_t)->(to),0,RValue)) && ((included_set((simplify_atrans_t1)->(pos),(simplify_atrans_t)->(pos),1,RValue)) && (included_set((simplify_atrans_t1)->(neg),(simplify_atrans_t)->(neg),1,RValue))))){break_1=1;
}
;
...
if (!(in_set(simplify_astates_acc,simplify_astates_i,RValue))){label[simplify_astates_i]=NULL;
...
while(print_alternating_t){if ((empty_set((print_alternating_t)->(pos),1,RValue)) && (empty_set((print_alternating_t)->(neg),1,RValue))){printf("1");
}
;
print_set(0,(print_alternating_t)->(pos),1);
if (!((empty_set((print_alternating_t)->(pos),1,RValue)) && (!(empty_set((print_alternating_t)->(neg),1,RValue))))){printf(" & ");
}
;
...
while((simplify_btrans_t==simplify_btrans_t1) || (((simplify_btrans_t)->(to)!=(simplify_btrans_t1)->(to)) || (!((included_set((simplify_btrans_t1)->(pos),(simplify_btrans_t)->(pos),1,RValue)) || (!(included_set((simplify_btrans_t1)->(neg),(simplify_btrans_t)->(neg),1,RValue))))))){simplify_btrans_t1=(simplify_btrans_t1)->(nxt);
}
;
...
while(!(same_btrans(all_btrans_match_s,all_btrans_match_t,RValue))){all_btrans_match_t=(all_btrans_match_t)->(nxt);
}
;
...
while(!(all_btrans_match(simplify_bstates_s,simplify_bstates_s1,RValue))){simplify_bstates_s1=(simplify_bstates_s1)->(nxt);
}
;
...
;
if ((bdfs_scc)->(rank)==(bdfs_scc)->(theta)){if (scc_stack==bdfs_scc){(s)->(incoming)=-1;
bdfs_t=(s)->(trans)->(nxt);
...
int return_1;
return_1=0;
if ((fin$!=accept) && (in_set(set,final[(fin$)+(1)],RValue))){return_1=1;
...
while(break_1==(0) && (make_btrans_t1!=(s)->(trans))){if ((tl_simp_fly) && ((make_btrans_1_to==(make_btrans_t1)->(to)) && ((included_set((make_btrans_t)->(pos),(make_btrans_t1)->(pos),1,RValue)) && (included_set((make_btrans_t)->(neg),(make_btrans_t1)->(neg),1,RValue))))){make_btrans_1_2_free=(make_btrans_t1)->(nxt);
...
} else {if ((tl_simp_fly) && (((make_btrans_t1)->(to)==make_btrans_1_to) && ((included_set((make_btrans_t1)->(pos),(make_btrans_t)->(pos),1,RValue)) && (included_set((make_btrans_t1)->(neg),(make_btrans_t)->(neg),1,RValue))))){break_1=1;
...
while(!(all_btrans_match(s,make_btrans_s1,RValue))){make_btrans_s1=(make_btrans_s1)->(nxt);
}
;
...
while(print_buchi_t!=(s)->(trans)){if ((empty_set((print_buchi_t)->(pos),1,RValue)) && (empty_set((print_buchi_t)->(neg),1,RValue))){printf("1");
}
;
print_set(0,(print_buchi_t)->(pos),1);
if (!((empty_set((print_buchi_t)->(pos),1,RValue)) && (!(empty_set((print_buchi_t)->(neg),1,RValue))))){printf(" & ");
}
;
...
while(break_1==(0) && (mk_buchi_t1!=(mk_buchi_s)->(trans))){if ((tl_simp_fly) && ((mk_buchi_1_to==(mk_buchi_t1)->(to)) && ((included_set((mk_buchi_t)->(pos),(mk_buchi_t1)->(pos),1,RValue)) && (included_set((mk_buchi_t)->(neg),(mk_buchi_t1)->(neg),1,RValue))))){mk_buchi_1_2_free=(mk_buchi_t1)->(nxt);
...
} else {if ((tl_simp_fly) && (((mk_buchi_t1)->(to)==mk_buchi_1_to) && ((included_set((mk_buchi_t1)->(pos),(mk_buchi_t)->(pos),1,RValue)) && (included_set((mk_buchi_t1)->(neg),(mk_buchi_t)->(neg),1,RValue))))){break_1=1;
...
;
while(simplify_bstates(RValue)){simplify_btrans(0);
if (tl_simp_scc){simplify_bscc(0);
}
;
}
...
;
in_cache_d=stored;
while(return_1==(0) && (in_cache_d)){if (isequal(0,(in_cache_d)->(before),n)){CacheHits=(CacheHits)+(1);
if (((in_cache_d)->(same)) && (ismatch(n,(in_cache_d)->(before),RValue))){return_1=1;
RValue=n;
}
;
if (return_1==0){return_1=1;
...
if (ismatch(0,(cached_d)->(before),(cached_d)->(after))){(cached_d)->(same)=1;
...
;
if (return_1==0){if (sameform(0,x,in)){return_1=1;
RValue=1;
}
;
...
;
if (return_1==0){if (one_lft(0,ntyp,x,(in)->(lft))){return_1=1;
RValue=1;
}
;
if (return_1==0){return_1=1;
...
;
if (return_1==0){if (!(one_lft(ntyp,(from)->(lft),in,RValue))){return_1=1;
RValue=0;
}
;
if (return_1==0){return_1=1;
...
int return_1;
return_1=0;
if (!(all_lfts(ntyp,a,b,RValue))){return_1=1;
RValue=0;
}
;
if (return_1==0){return_1=1;
...
if (!(sameform((a)->(lft),(b)->(lft),RValue))){return_1=1;
RValue=0;
}
;
if (return_1==0){if (!(sameform((a)->(rgt),(b)->(rgt),RValue))){return_1=1;
RValue=0;
}
;
if (return_1==0){return_1=1;
...
;
if (return_1==0){if ((isequal((a)->(lft),(b)->(lft),RValue)) && (isequal((a)->(rgt),(b)->(rgt),RValue))){return_1=1;
RValue=1;
}
;
if (return_1==0){return_1=1;
...
;
if (return_1==0){if ((ismatch((a)->(lft),(b)->(lft),RValue)) && (ismatch((a)->(rgt),(b)->(rgt),RValue))){return_1=1;
RValue=1;
}
;
if (return_1==0){return_1=1;
...
;
if (return_1==0){if ((in)->(ntyp)==AND_1){empty tree string;
}
;
if (return_1==0){return_1=1;
...
;
if (return_1==0){if ((in)->(ntyp)==OR_1){empty tree string;
}
;
if (return_1==0){return_1=1;
RValue=isequal(0,in,srch);
...
int return_1;
return_1=0;
if (((s)->(to)!=(t)->(to)) || (!((same_sets((s)->(pos),(t)->(pos),1,RValue)) || (!(same_sets((s)->(neg),(t)->(neg),1,RValue)))))){return_1=1;
RValue=0;
}
;
if (return_1==0){if (same_sets(0,(s)->(final),(t)->(final),0)){return_1=1;
RValue=1;
}
;
if (return_1==0){if ((use_scc) && ((in_set(bad_scc,(a)->(incoming),RValue)) || ((in_set(bad_scc,(b)->(incoming),RValue)) || (((a)->(incoming)!=(s)->(to)->(incoming)) || ((b)->(incoming)!=(t)->(to)->(incoming)))))){return_1=1;
RValue=1;
}
;
if (return_1==0){return_1=1;
...
while(!((simplify_gtrans_t!=simplify_gtrans_t1) && (((simplify_gtrans_t1)->(to)==(simplify_gtrans_t)->(to)) && ((included_set((simplify_gtrans_t1)->(pos),(simplify_gtrans_t)->(pos),1,RValue)) && ((included_set((simplify_gtrans_t1)->(neg),(simplify_gtrans_t)->(neg),1,RValue)) && ((included_set((simplify_gtrans_t)->(final),(simplify_gtrans_t1)->(final),0,RValue)) || ((tl_simp_scc) && (((simplify_gtrans_s)->(incoming)!=(simplify_gtrans_t)->(to)->(incoming)) || (in_set(bad_scc,(simplify_gtrans_s)->(incoming),RValue)))))))))){simplify_gtrans_t1=(simplify_gtrans_t1)->(nxt);
}
;
...
while(!(same_gtrans(a,all_gtrans_match_s,b,all_gtrans_match_t,use_scc,RValue))){all_gtrans_match_t=(all_gtrans_match_t)->(nxt);
}
;
...
all_gtrans_match_s=(a)->(trans)->(nxt);
while(!(same_gtrans(a,all_gtrans_match_s,b,all_gtrans_match_t,use_scc,RValue))){all_gtrans_match_s=(all_gtrans_match_s)->(nxt);
}
;
...
while(!(all_gtrans_match(simplify_gstates_a,simplify_gstates_b,tl_simp_scc,RValue))){simplify_gstates_b=(simplify_gstates_b)->(nxt);
}
;
...
simplify_gscc_i=0;
while(simplify_gscc_i<scc_id){if (!(included_set(final_set,simplify_gscc_scc_final[simplify_gscc_i],0,RValue))){add_set(0,bad_scc,simplify_gscc_i);
}
;
simplify_gscc_i=(simplify_gscc_i)+(1);
}
...
int is_final_in_to;
return_1=0;
if (((tl_fjtofj) && (!(in_set((at)->(to),i,RValue)))) || (!((tl_fjtofj) && (!(in_set(from,i,RValue)))))){return_1=1;
RValue=1;
}
;
...
while(return_1==(0) && (is_final_t)){if ((included_set((is_final_t)->(to),(at)->(to),0,RValue)) && ((included_set((is_final_t)->(pos),(at)->(pos),1,RValue)) && (included_set((is_final_t)->(neg),(at)->(neg),1,RValue)))){if (is_final_in_to){add_set(0,(at)->(to),i);
}
;
return_1=1;
RValue=1;
...
int return_1;
return_1=0;
if (same_sets(0,set,(s)->(nodes_set),0)){return_1=1;
RValue=s;
}
;
if (return_1==0){s=(gstack)->(nxt);
(gstack)->(nodes_set)=set;
while(!(same_sets(set,(s)->(nodes_set),0,RValue))){s=(s)->(nxt);
}
;
...
;
if (!(empty_set(set,0,RValue))){gstate_id=(gstate_id)+(1);
}
;
(s)->(incoming)=0;
...
make_gtrans_i=1;
while(make_gtrans_i<final[0]){if (is_final(0,(s)->(nodes_set),make_gtrans_t1,final[make_gtrans_i])){add_set(0,fin$,final[make_gtrans_i]);
}
;
make_gtrans_i=(make_gtrans_i)+(1);
}
...
while(break_1==(0) && (make_gtrans_2_3_t2!=(s)->(trans))){if ((tl_simp_fly) && ((included_set((make_gtrans_t1)->(to),(make_gtrans_2_3_t2)->(to)->(nodes_set),0,RValue)) && ((included_set((make_gtrans_t1)->(pos),(make_gtrans_2_3_t2)->(pos),1,RValue)) && ((included_set((make_gtrans_t1)->(neg),(make_gtrans_2_3_t2)->(neg),1,RValue)) && (same_sets(fin$,(make_gtrans_2_3_t2)->(final),0,RValue)))))){make_gtrans_2_3_5_free=(make_gtrans_2_3_t2)->(nxt);
...
} else {if ((tl_simp_fly) && ((included_set((make_gtrans_2_3_t2)->(to)->(nodes_set),(make_gtrans_t1)->(to),0,RValue)) && ((included_set((make_gtrans_2_3_t2)->(pos),(make_gtrans_t1)->(pos),1,RValue)) && ((included_set((make_gtrans_2_3_t2)->(neg),(make_gtrans_t1)->(neg),1,RValue)) && (same_sets((make_gtrans_2_3_t2)->(final),fin$,0,RValue)))))){break_1=1;
...
while(!(all_gtrans_match(s,make_gtrans_s1,0,RValue))){make_gtrans_s1=(make_gtrans_s1)->(nxt);
}
;
...
while(reverse_print_generalized_t!=(s)->(trans)){if ((empty_set((reverse_print_generalized_t)->(pos),1,RValue)) && (empty_set((reverse_print_generalized_t)->(neg),1,RValue))){printf("1");
}
;
print_set(0,(reverse_print_generalized_t)->(pos),1);
if (!((empty_set((reverse_print_generalized_t)->(pos),1,RValue)) && (!(empty_set((reverse_print_generalized_t)->(neg),1,RValue))))){printf(" & ");
}
;
...
;
if (!(empty_set((mk_generalized_t)->(to),0,RValue))){gstate_id=(gstate_id)+(1);
}
;
...
;
while(simplify_gstates(RValue)){if (tl_simp_scc){simplify_gscc(0);
}
;
simplify_gtrans(0);
if (tl_simp_scc){simplify_gscc(0);
...
while(tst(getword_c,RValue)){yytext[getword_i]=getword_c;
getword_i=(getword_i)+(1);
getword_1_temp$_1=tl_Getchar(0);
getword_c=getword_1_temp$_1;
}
...
;
if (return_1==0){if (strcmp("false",yytext)==0){return_1=1;
tl_yylval=tl_nn(0,FALSE,NULL,NULL);
RValue=FALSE;
}
;
if (return_1==0){return_1=1;
tl_yylval=tl_nn(0,PREDICATE,NULL,NULL);
...
if (tl_lex_c=='>'){return_1=1;
tl_yylval=tl_nn(0,EVENTUALLY,NULL,NULL);
RValue=EVENTUALLY;
}
;
...
tl_lex_c=tl_Getchar(0);
if (tl_lex_c=='>'){return_1=1;
tl_yylval=tl_nn(0,EQUIV,NULL,NULL);
RValue=EQUIV;
}
;
if (return_1==0){tl_UnGetchar(0);
...
;
if (break_1$==0){if (implies(0,(ptr)->(lft),(ptr)->(rgt))){ptr=(ptr)->(rgt);
break_1$=1;
}
;
if (break_1$==0){if ((ptr)->(lft)->(ntyp)==(U_OPER) && (isequal((ptr)->(lft)->(lft),(ptr)->(rgt),RValue))){(ptr)->(lft)=(ptr)->(lft)->(rgt);
break_1$=1;
}
;
if (break_1$==0){if ((ptr)->(rgt)->(ntyp)==(U_OPER) && (implies((ptr)->(lft),(ptr)->(rgt)->(lft),RValue))){ptr=(ptr)->(rgt);
break_1$=1;
}
;
...
if ((ptr)->(lft)->(ntyp)!=(TRUE) && (implies(bin_simpler_1_2_8_temp$_3,(ptr)->(lft),RValue))){break_1$=1;
...
;
if (break_1$==0){if (implies(0,(ptr)->(rgt),(ptr)->(lft))){ptr=(ptr)->(rgt);
break_1$=1;
}
;
...
;
if (break_1$==0){if ((ptr)->(rgt)->(ntyp)==(V_OPER) && (implies((ptr)->(rgt)->(lft),(ptr)->(lft),RValue))){ptr=(ptr)->(rgt);
break_1$=1;
}
;
...
if ((ptr)->(lft)->(ntyp)!=(FALSE) && (implies((ptr)->(lft),bin_simpler_1_2_14_temp$_6,RValue))){break_1$=1;
...
if (implies(0,(ptr)->(lft),(ptr)->(rgt))){break_1$=1;
...
if ((implies((ptr)->(lft),(ptr)->(rgt),RValue)) && (implies((ptr)->(rgt),(ptr)->(lft),RValue))){break_1$=1;
ptr=tl_nn(0,TRUE,NULL,NULL);
}
;
...
if ((ptr)->(rgt)->(ntyp)==(U_OPER) && (isequal((ptr)->(rgt)->(rgt),(ptr)->(lft),RValue))){ptr=(ptr)->(lft);
break_1$=1;
}
;
if (break_1$==0){if ((ptr)->(lft)->(ntyp)==(U_OPER) && (isequal((ptr)->(lft)->(rgt),(ptr)->(rgt),RValue))){ptr=(ptr)->(rgt);
break_1$=1;
}
;
if (break_1$==0){if ((ptr)->(rgt)->(ntyp)==(V_OPER) && (isequal((ptr)->(rgt)->(rgt),(ptr)->(lft),RValue))){ptr=(ptr)->(rgt);
break_1$=1;
}
;
if (break_1$==0){if ((ptr)->(lft)->(ntyp)==(V_OPER) && (isequal((ptr)->(lft)->(rgt),(ptr)->(rgt),RValue))){ptr=(ptr)->(lft);
break_1$=1;
}
;
if (break_1$==0){if ((ptr)->(rgt)->(ntyp)==(U_OPER) && ((ptr)->(lft)->(ntyp)==(U_OPER) && (isequal((ptr)->(rgt)->(rgt),(ptr)->(lft)->(rgt),RValue)))){break_1$=1;
...
;
if (break_1$==0){if ((ptr)->(rgt)->(ntyp)==(V_OPER) && ((ptr)->(lft)->(ntyp)==(V_OPER) && (isequal((ptr)->(rgt)->(lft),(ptr)->(lft)->(lft),RValue)))){break_1$=1;
...
;
if (break_1$==0){if ((ptr)->(rgt)->(ntyp)==(U_OPER) && ((ptr)->(lft)->(ntyp)==(V_OPER) && (isequal((ptr)->(lft)->(rgt),(ptr)->(rgt)->(rgt),RValue)))){ptr=(ptr)->(lft);
break_1$=1;
}
;
if (break_1$==0){if ((isequal((ptr)->(lft),(ptr)->(rgt),RValue)) || ((ptr)->(rgt)->(ntyp)==(FALSE) || ((ptr)->(lft)->(ntyp)==(TRUE) || (implies((ptr)->(rgt),(ptr)->(lft),RValue))))){ptr=(ptr)->(rgt);
break_1$=1;
}
;
if (break_1$==0){if ((ptr)->(rgt)->(ntyp)==(TRUE) || ((ptr)->(lft)->(ntyp)==(FALSE) || (implies((ptr)->(lft),(ptr)->(rgt),RValue)))){ptr=(ptr)->(lft);
break_1$=1;
}
;
...
if ((implies((ptr)->(lft),bin_simpler_1_2_27_temp$_32,RValue)) || (implies((ptr)->(rgt),bin_simpler_1_2_27_temp$_29,RValue))){break_1$=1;
ptr=tl_nn(0,FALSE,NULL,NULL);
}
;
if (break_1$==0){break_1$=1;
}
...
if ((ptr)->(rgt)->(ntyp)==(U_OPER) && (isequal((ptr)->(rgt)->(rgt),(ptr)->(lft),RValue))){ptr=(ptr)->(rgt);
break_1$=1;
}
;
if (break_1$==0){if ((ptr)->(rgt)->(ntyp)==(V_OPER) && (isequal((ptr)->(rgt)->(rgt),(ptr)->(lft),RValue))){ptr=(ptr)->(lft);
break_1$=1;
}
;
if (break_1$==0){if ((ptr)->(rgt)->(ntyp)==(U_OPER) && ((ptr)->(lft)->(ntyp)==(U_OPER) && (isequal((ptr)->(rgt)->(lft),(ptr)->(lft)->(lft),RValue)))){break_1$=1;
...
;
if (break_1$==0){if ((isequal((ptr)->(lft),(ptr)->(rgt),RValue)) || ((ptr)->(rgt)->(ntyp)==(FALSE) || ((ptr)->(lft)->(ntyp)==(TRUE) || (implies((ptr)->(rgt),(ptr)->(lft),RValue))))){ptr=(ptr)->(lft);
break_1$=1;
}
;
if (break_1$==0){if ((ptr)->(rgt)->(ntyp)==(TRUE) || ((ptr)->(lft)->(ntyp)==(FALSE) || (implies((ptr)->(lft),(ptr)->(rgt),RValue)))){ptr=(ptr)->(rgt);
break_1$=1;
}
;
if (break_1$==0){if ((ptr)->(rgt)->(ntyp)==(V_OPER) && ((ptr)->(lft)->(ntyp)==(V_OPER) && (isequal((ptr)->(lft)->(rgt),(ptr)->(rgt)->(rgt),RValue)))){break_1$=1;
...
;
if (break_1$==0){if ((ptr)->(rgt)->(ntyp)==(U_OPER) && ((ptr)->(lft)->(ntyp)==(V_OPER) && (isequal((ptr)->(lft)->(rgt),(ptr)->(rgt)->(rgt),RValue)))){ptr=(ptr)->(rgt);
break_1$=1;
}
;
...
if ((implies(bin_simpler_1_2_36_temp$_44,(ptr)->(lft),RValue)) || (implies(bin_simpler_1_2_36_temp$_41,(ptr)->(rgt),RValue))){break_1$=1;
ptr=tl_nn(0,TRUE,NULL,NULL);
}
;
if (break_1$==0){break_1$=1;
...
;
if (return_1==0){if (addcan_cmp<0){if (!addcan_prev){return_1=1;
can=tl_nn(0,tok,addcan_N,can);
...
;
if (return_1==0){if (goto==0){addcan_ptr=&(addcan_prev)->(rgt);
}
;
}
;
...
;
if (isequal(0,Canonical_k1,Canonical_k2)){marknode(0,AND_1,Canonical_p);
continue_1=1;
Canonical_p=if ((Canonical_p)->(ntyp)==AND_1) (Canonical_p)->(rgt) else NULL 
;
}
;
if (continue_1==0){if (anywhere(0,OR_1,Canonical_k1,Canonical_k2)){marknode(0,AND_1,Canonical_p);
continue_1=1;
Canonical_p=if ((Canonical_p)->(ntyp)==AND_1) (Canonical_p)->(rgt) else NULL 
;
}
;
if (continue_1==0){if ((Canonical_k2)->(ntyp)==(U_OPER) && (anywhere(AND_1,(Canonical_k2)->(rgt),can,RValue))){marknode(0,AND_1,Canonical_p);
continue_1=1;
Canonical_p=if ((Canonical_p)->(ntyp)==AND_1) (Canonical_p)->(rgt) else NULL 
;
}
...
;
if (isequal(0,Canonical_k1,Canonical_k2)){marknode(0,OR_1,Canonical_p);
continue_1=1;
Canonical_p=if ((Canonical_p)->(ntyp)==OR_1) (Canonical_p)->(rgt) else NULL 
;
}
;
if (continue_1==0){if (anywhere(0,AND_1,Canonical_k1,Canonical_k2)){marknode(0,OR_1,Canonical_p);
continue_1=1;
Canonical_p=if ((Canonical_p)->(ntyp)==OR_1) (Canonical_p)->(rgt) else NULL 
;
}
;
if (continue_1==0){if ((Canonical_k2)->(ntyp)==(V_OPER) && ((Canonical_k2)->(lft)->(ntyp)==(FALSE) && (anywhere(AND_1,(Canonical_k2)->(rgt),can,RValue)))){marknode(0,OR_1,Canonical_p);
continue_1=1;
Canonical_p=if ((Canonical_p)->(ntyp)==OR_1) (Canonical_p)->(rgt) else NULL 
;
}
...
dump(0,dump_cond_q);
dump_cond_frst=0;
} else {if ((dump_cond_q)->(ntyp)==(V_OPER) && (!(anywhere(AND_1,(dump_cond_q)->(rgt),r,RValue)))){dump_cond_frst=dump_cond(0,(dump_cond_q)->(rgt),r,dump_cond_frst);
